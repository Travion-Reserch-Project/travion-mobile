...
// Loading animation is handled by LottieView component in TypingIndicator
...
const TypingIndicator: React.FC<{ message?: string }> = ({
  message = 'AI is creating your plan...',
}) => {
    ...
    <View style={styles.typingContainer}>
      ...
      <View style={styles.typingBubble}>
        <View style={styles.typingDotsContainer}>
          ...
          <Animated.View
            style={[styles.typingDot, styles.typingDotMiddle, { opacity: pulseAnim }]}
          />
          <Animated.View style={[styles.typingDot, { opacity: pulseAnim }]} />
        </View>
...
export const TourPlanChatScreen: React.FC<TourPlanChatScreenProps> = ({ route, navigation }) => {
  ...
  const generateInitialPlan = async () => {
    ...
    const welcomeMessage: ChatMessage = {
      ...
      } selected locations for ${formatDateRange(
        startDate,
        endDate,
